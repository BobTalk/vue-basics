<template>
  <div class="relative clearfix">
    ...
    <div class="mainClass">
      <el-menu :default-active="activeIndex" class="el-menu-demo menuClass" mode="horizontal" @select="handleSelect">
              ...
              <template v-if="val.children.length">
                <el-submenu :index="gernerateId(key,valIndex)" :key="valIndex">
                  ...
                  <template v-for="(v,k) in val.children">
                    <el-menu-item :index="gernerateId(key,valIndex,k)" :data-path="v.path" :key="k">{{v.title}}
                    </el-menu-item>
                  </template>
                </el-submenu>
              </template>
